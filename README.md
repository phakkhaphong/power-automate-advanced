...
**ชื่อหลักสูตร:** Power Automate Advanced: From JSON to Enterprise-Grade Workflow Automation

**ระยะเวลาอบรม:** 1 วัน (09:00 – 17:00)
...
1. เข้าใจหลักการทำงานของ Power Automate ในฐานะ Workflow Orchestration Engine ที่ใช้ JSON Objects เป็นศูนย์กลางของการประมวลผล

2. สามารถสร้าง Flow ที่ซับซ้อน โดยใช้ Expressions, Variables, Loops และ Conditions ได้อย่างมั่นใจ

3. ใช้ Error Handling และ Approval Flow ได้อย่างมีประสิทธิภาพและปลอดภัย

4. ออกแบบ Parent–Child Flows เพื่อนำกลับมาใช้ซ้ำ และประยุกต์ใช้ Best Practices สำหรับการพัฒนา Workflow ในระดับองค์กร

5. เสริมความรู้ด้าน Governance, Monitoring และ Security เพื่อให้ Flow มีความน่าเชื่อถือและรองรับการทำงานจริง

---

## กลุ่มผู้เรียนเป้าหมาย

- ผู้ที่มีประสบการณ์ใช้งาน Power Automate ในระดับพื้นฐาน–กลาง และต้องการยกระดับสู่ Advanced
- Business Analyst, Developer, IT Professional ที่รับผิดชอบงาน Automation ภายในองค์กร
- ผู้ที่ต้องการออกแบบ Workflow ที่ซับซ้อน เชื่อมโยงหลายระบบ และจัดการ Error Handling อย่างเป็นระบบ
...
- Configure Run After และ Retry Policy
