...
**Exercise นี้อยู่ในไฟล์แยก**: [Exercise-6a-Child-Flow.md](./Exercise-6a-Child-Flow.md)

**สิ่งที่คุณจะได้ทำ**:
1. ✅ สร้าง Child Flow ที่สามารถนำกลับมาใช้ซ้ำได้
2. ✅ ใช้ HTTP Request Trigger เพื่อรับ Input Parameters
3. ✅ กำหนด Request Body JSON Schema
4. ✅ ใช้ Switch Condition เพื่อจัดการหลาย Case
5. ✅ ส่ง Email และสร้าง Calendar Event ตาม Case
6. ✅ ใช้ Response Action เพื่อส่งผลลัพธ์กลับไปยัง Parent Flow
...
**Exercise นี้อยู่ในไฟล์แยก**: [Exercise-6b-Parent-Flow.md](./Exercise-6b-Parent-Flow.md)

**สิ่งที่คุณจะได้ทำ**:
1. ✅ สร้าง Parent Flow ที่เรียกใช้ Child Flow
2. ✅ ใช้ Microsoft Forms Trigger และ Get response details
3. ✅ ใช้ HTTP Request Action เพื่อเรียกใช้ Child Flow
4. ✅ ส่ง Input Parameters ไปยัง Child Flow
5. ✅ รับ Response จาก Child Flow และจัดการผลลัพธ์
6. ✅ ใช้ Parse JSON เพื่อแปลง Response
7. ✅ จัดการ Error เมื่อ Child Flow ทำงานไม่สำเร็จ

> 📖 **คำแนะนำ**: ต้องสร้าง Child Flow (Exercise 6a) ก่อน แล้วค่อยสร้าง Parent Flow (Exercise 6b)
